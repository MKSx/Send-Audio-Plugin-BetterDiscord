//META{"name": "AudioPluginDev", "version": "1.3.2", "source": "https://github.com/MKSx/EnviarAudio-BetterDiscord/blob/master/enviaraudio.plugin.js"}*//
...
class AudioPluginDev{
	getName(){
		return 'Envia Áudio | Versão de desenvolvimento';
	}
	getDescription(){
	...
	initialize(){
		...
		this.onSwitch();
	 	...
	 	ZLibrary.PluginUpdater.checkForUpdate(this.getName(), this.getVersion(), "https://raw.githubusercontent.com/MKSx/EnviarAudio-BetterDiscord/master/enviaraudio.dev.plugin.js")
	}
	onSwitch(){
